...
| low        | float      | Lowest price within the second |
| close      | float      | Closing price within the second |
| volume     | integer    | Total trading volume within the second |
| symbol     | string     | Company's ticker |
